...
pub mod aoc_2021_15_cli;
pub mod aoc_2021_15b_cli;
pub mod aoc_2021_16_cli;
pub mod aoc_2021_16b_cli;
pub mod aoc_2021_17_cli;
pub mod aoc_2021_17b_cli;
...
pub enum Command {
    ...
    #[clap(name = "day-15", setting(AppSettings::ArgRequiredElseHelp))]
    DAY15 {
        #[clap(required = true, parse(from_os_str))]
        path: PathBuf,
    },
    #[clap(name = "day-15b", setting(AppSettings::ArgRequiredElseHelp))]
    DAY15B {
        #[clap(required = true, parse(from_os_str))]
        path: PathBuf,
    },
    #[clap(name = "day-16", setting(AppSettings::ArgRequiredElseHelp))]
    DAY16 {
        #[clap(required = true, parse(from_os_str))]
        path: PathBuf,
    },
    #[clap(name = "day-16b", setting(AppSettings::ArgRequiredElseHelp))]
    DAY16B {
        #[clap(required = true, parse(from_os_str))]
        path: PathBuf,
    },
    #[clap(name = "day-17", setting(AppSettings::ArgRequiredElseHelp))]
    DAY17 {
        #[clap(required = true, parse(from_os_str))]
        path: PathBuf,
    },
    #[clap(name = "day-17b", setting(AppSettings::ArgRequiredElseHelp))]
    DAY17B {
        #[clap(required = true, parse(from_os_str))]
        path: PathBuf,
    },
